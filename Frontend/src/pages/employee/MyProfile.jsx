        ...
        <div className="flex min-h-screen bg-gray-50">
            ...
            <div className="flex-1 w-full ml-0 lg:ml-64">
                <div className="p-6 lg:p-10 max-w-7xl mx-auto">
                    ...
                    {/* Profile Header Card */}
                    <div className="bg-gradient-to-r from-gray-900 to-black rounded-xl shadow-lg mb-8 overflow-hidden">
                        <div className="p-8">
                            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-8">
                                {/* Profile Avatar */}
                                <div className="relative">
                                    <div className="w-32 h-32 rounded-full border-4 border-gray-700 shadow-xl overflow-hidden bg-gray-800">
                                    ...
                                    {/* Online Status */}
                                    <div className="absolute bottom-4 right-4 w-6 h-6 bg-green-500 rounded-full border-3 border-gray-900 shadow-lg"></div>
                                </div>
                                ...
                                <div className="flex-1 text-center lg:text-left">
                                    <div className="mb-6">
                                        ...
                                        <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 text-gray-300">
                                            <span className="flex items-center gap-2 px-3 py-1 bg-gray-800 rounded-full">
                                            ...
                                            <span className="px-3 py-1 bg-gray-800 text-gray-100 rounded-full font-medium">
                                                {profileData.status}
                                            </span>
                                        </div>
                                    </div>
                                    ...
                                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                        <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                                            <p className="text-2xl font-bold text-white">{profileData.leaveBalance?.annual || 0}</p>
                                            <p className="text-gray-300 text-sm">Annual Leave</p>
                                        </div>
                                        <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                                            <p className="text-2xl font-bold text-white">{profileData.leaveBalance?.sick || 0}</p>
                                            <p className="text-gray-300 text-sm">Sick Leave</p>
                                        </div>
                                        <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                                            <p className="text-2xl font-bold text-white">{profileData.leaveBalance?.personal || 0}</p>
                                            <p className="text-gray-300 text-sm">Personal Leave</p>
                                        </div>
                                        <div className="text-center p-4 bg-gray-800/50 rounded-lg">
                                            ...
                                            <p className="text-gray-300 text-sm">Total Leave</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white rounded-xl shadow-sm p-8 border border-gray-200">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-4">
                                        <div>
                                            <label className="text-sm font-medium text-gray-500 block mb-2">Work Email</label>
                                            <div className="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
                                                <svg className="w-5 h-5 text-gray-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                                                </svg>
                                                <span className="text-gray-900 font-medium">{profileData.personalEmail}</span>
                                            </div>
                                        </div>
                                        <div>
                                            <label className="text-sm font-medium text-gray-500 block mb-2">Personal Email</label>
                                            <div className="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
                                                <svg className="w-5 h-5 text-gray-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
                                                    <path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" />
                                                    <path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" />
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        <div>
                                            <label className="text-sm font-medium text-gray-500 block mb-2">Work Location</label>
                                            <div className="flex items-center p-3 bg-gray-50 rounded-lg border border-gray-200">
                                                <svg className="w-5 h-5 text-gray-400 mr-3" fill="currentColor" viewBox="0 0 20 20">
                            ...
                            <div className="bg-white rounded-xl shadow-sm p-8 border border-gray-200">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-6">
                                        ...
                                        <div>
                                            <label className="text-sm font-medium text-gray-500 block mb-2">Date of Joining</label>
                                            <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                                    ...
                                    <div className="space-y-6">
                                        <div>
                                            <label className="text-sm font-medium text-gray-500 block mb-2">Reporting Manager</label>
                                            <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                                                <p className="text-gray-900 font-medium">{profileData.reportingManager || 'Not assigned'}</p>
                                            </div>
                                        </div>
                                        <div>
                                            <label className="text-sm font-medium text-gray-500 block mb-2">Contract Type</label>
                                            <div className="p-3 bg-gray-50 rounded-lg border border-gray-200">
                            ...
                            <div className="bg-gray-900 rounded-xl shadow-lg p-6 text-white">
                                <div className="flex items-center gap-4 mb-6">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-2xl font-bold capitalize">{profileData.status}</p>
                                    </div>
                                </div>
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center">
                                        <span className="text-sm text-gray-300">Active Since</span>
                                        <span className="font-semibold">{formatDate(profileData.joiningDate)}</span>
                                    </div>
                                    <div className="flex justify-between items-center">
